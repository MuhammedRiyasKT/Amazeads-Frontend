...
import { ChevronRight, LayoutGrid, Truck, ClipboardList, Scissors, Folder, Printer, XOctagon } from "lucide-react";
...
export default function DailyOperationsGrid() {
  const items = [
    ...
    { label: "Pending task", count: "8 tasks", icon: ClipboardList, badgeClass: styles.badgeOrange, iconClass: styles.opsIconOrange },
    ...
    { label: "Cancelled", count: "2 items", icon: XOctagon, badgeClass: styles.badgeOrangeYellow, iconClass: styles.opsIconOrangeYellow },
  ];
