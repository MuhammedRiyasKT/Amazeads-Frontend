...
import { getProjectsForDesignList, UserRole } from "@/modules/project-manager/services/managerOrder.service";
import { useProjectManagerStore } from "@/store/projectManagerStore";
import { CATEGORY_IDS } from "@/constants/categories";
import SalesProjectDetailsModal from "@/modules/sales/components/SalesProjectDetailsModal";
import AssignTaskModal from "@/modules/project-manager/components/AssignTaskModal";
...
export function ProductForDesignPage({ role = "project-manager" }: { role?: UserRole }) {
...
export default ProductForDesignPage;
