  ...
  const fetchProjects = async () => {
    ...
    try {
      ...
      const filteredOrders = (data.items || []).map((order: any) => {
        ...
        return { ...order, projects: unassignedProjects };
  ...
  return (
    <div className={styles.container}>
      <div className={styles.headerRow}>
        <h1 className={styles.title}>Production Projects</h1>
        <p className={styles.subtitle}>Review active projects and delegate tasks to specific departments.</p>
      </div>
