...
import { SalesReportItem, StaffReport } from "../types/reports.types";
...
export default function SalesReportDetailsDrawer({
  ...
  // Reset tab and staff data when report changes or drawer opens
  useEffect(() => {
    if (isOpen) {
      setActiveTab("period");
      setStaffReports([]);
  ...
  // Fetch Staff-wise Report Callback
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-0.5">
                Period sales, collection, category &amp; staff breakdown
              </p>
            </div>
          </div>
