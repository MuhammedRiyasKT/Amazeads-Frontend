...
export default function AccountsSalesReportPage() {
  ...
  const handleRowDrillDown = (item: SalesReportItem) => {
    if (periodType === "year") {
      let yr = "";
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">
            Track sales, collections, and order performance across Day, Week, Month, and Year periods.
          </p>
        </div>
          ...
          <div className="p-12 md:p-16 flex flex-col items-center justify-center text-center space-y-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-slate-500 max-w-sm mx-auto">
                Try changing the selected period or date filters to view sales reports.
              </p>
            </div>
            {hasActiveFilters && (
              <button
