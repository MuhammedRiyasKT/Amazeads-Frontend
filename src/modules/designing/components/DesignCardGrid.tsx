...
export default function DesignCardGrid() {
  return (
    <div className={styles.cardGrid}>
      {/* Card 1: Overdue Design Job (Red Theme) */}
      <div className={`${styles.jobCard} ${styles.cardOverdue}`}>
        <div className={styles.jobHeader}>
          <span className={`${styles.jobBadge} ${styles.badgeOverdue}`}>! OVERDUE DESIGN JOB</span>
        ...
        <div className={`${styles.instructionsBox} ${styles.instOverdue}`}>
          <p className={styles.instText}>
            High-res vector trace, adjust curves for optimal large format printing. Ensure text paths are expanded for final production.
          </p>
        </div>
        ...
        <div className={styles.actionRow}>
          ...
          <Button variant="primary" size="sm" className={`${styles.btnFinish} w-full`}>
            <CheckSquare size={15} /> Finish Design
          </Button>
        </div>
      </div>

      {/* Card 2: Queued Design Job (Purple Theme) */}
      <div className={`${styles.jobCard} ${styles.cardQueued}`}>
        ...
        <div className={`${styles.instructionsBox} ${styles.instQueued}`}>
          <p className={styles.instText}>
            12x36 spread layout, 15 high-res photos. Color correction required for outdoor ceremony shots to match studio quality.
          </p>
        </div>
        ...
        <div className={styles.actionRow}>
          ...
          <Button variant="primary" size="sm" className={`${styles.btnStart} w-full`}>
            <Play size={14} fill="currentColor" /> Start Design
          </Button>
        </div>
      </div>
    </div>
